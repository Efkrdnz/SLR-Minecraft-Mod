...
import net.solocraft.procedures.IceChunkOnEntityTickUpdateProcedure;
...
public class IceChunkEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<Integer> DATA_life = SynchedEntityData.defineId(IceChunkEntity.class, EntityDataSerializers.INT);
	...
	public IceChunkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SololevelingModEntities.ICE_CHUNK.get(), world);
	}

	public IceChunkEntity(EntityType<IceChunkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "icechunktext");
	...
	public void baseTick() {
		super.baseTick();
		IceChunkOnEntityTickUpdateProcedure.execute(this);
