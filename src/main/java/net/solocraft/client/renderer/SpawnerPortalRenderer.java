...
public class SpawnerPortalRenderer extends GeoEntityRenderer<SpawnerPortalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SpawnerPortalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 2.4f;
