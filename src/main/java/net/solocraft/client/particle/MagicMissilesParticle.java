...
public class MagicMissilesParticle extends TextureSheetParticle {
	public static MagicMissilesParticleProvider provider(SpriteSet spriteSet) {
		return new MagicMissilesParticleProvider(spriteSet);
	}
	...
	public static class MagicMissilesParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			MagicMissilesParticle particle = new MagicMissilesParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
