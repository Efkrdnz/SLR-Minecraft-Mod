...
import net.solocraft.entity.model.DummyPortalNormalModel;
...
public class DummyPortalNormalRenderer extends GeoEntityRenderer<DummyPortalNormalEntity> {
	public DummyPortalNormalRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, DummyPortalNormalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
