...
public class SpiderBossEntity extends Monster implements GeoEntity {
	...
	public SpiderBossEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SololevelingModEntities.SPIDER_BOSS.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "spidertext");
	}
