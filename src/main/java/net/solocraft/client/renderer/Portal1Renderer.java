...
import net.solocraft.entity.model.Portal1Model;
...
public class Portal1Renderer extends GeoEntityRenderer<Portal1Entity> {
	public Portal1Renderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, Portal1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
