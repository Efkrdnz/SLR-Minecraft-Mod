...
public class PortalKargalgansThroneRoomRightClickedOnEntityProcedure {
								...
								_datEntSetL.getEntityData().set(PortalKargalgansThroneRoomEntity.DATA_usedbefore, true);
							{
								...
								if (!_ent.level().isClientSide() && _ent.getServer() != null) {
									_ent.getServer().getCommands().performPrefixedCommand(
											...
											"execute in sololeveling:dungeon_dimension_a as @s at @s unless entity @e[type=sololeveling:portal_12,distance=..100] run spawnkargalganthrone");
								}
							}
							sourceentity.getPersistentData().putString("dungeon_tag", (entity.getStringUUID()));
						}
