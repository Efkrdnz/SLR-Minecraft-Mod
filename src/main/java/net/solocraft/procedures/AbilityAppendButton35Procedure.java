...
public class AbilityAppendButton35Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		String ability_to_append = "";
		if (!(PlistReturn35Procedure.execute(entity)).equals("empty")) {
			if (entity instanceof Player _player)
				_player.closeContainer();
			ability_to_append = PlistReturn35Procedure.execute(entity);
