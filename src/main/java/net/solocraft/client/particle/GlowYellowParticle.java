...
public class GlowYellowParticle extends TextureSheetParticle {
	public static GlowYellowParticleProvider provider(SpriteSet spriteSet) {
		return new GlowYellowParticleProvider(spriteSet);
	}
	...
	public static class GlowYellowParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			GlowYellowParticle particle = new GlowYellowParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
