...
public class CleaveParticle extends TextureSheetParticle {
	public static CleaveParticleProvider provider(SpriteSet spriteSet) {
		return new CleaveParticleProvider(spriteSet);
	}
	...
	public static class CleaveParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			CleaveParticle particle = new CleaveParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
