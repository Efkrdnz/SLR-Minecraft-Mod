...
import net.solocraft.entity.model.SkeletonWarriorModel;
...
public class SkeletonWarriorRenderer extends GeoEntityRenderer<SkeletonWarriorEntity> {
	public SkeletonWarriorRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, SkeletonWarriorEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
