...
public class AbilityAppendButton44Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		String ability_to_append = "";
		if (!(PlistReturn44Procedure.execute(entity)).equals("empty")) {
			if (entity instanceof Player _player)
				_player.closeContainer();
			ability_to_append = PlistReturn44Procedure.execute(entity);
