...
public class FangedKasakaRenderer extends GeoEntityRenderer<FangedKasakaEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FangedKasakaEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
