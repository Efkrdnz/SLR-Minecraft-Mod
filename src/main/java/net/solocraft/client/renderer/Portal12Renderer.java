...
public class Portal12Renderer extends GeoEntityRenderer<Portal12Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, Portal12Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 2f;
