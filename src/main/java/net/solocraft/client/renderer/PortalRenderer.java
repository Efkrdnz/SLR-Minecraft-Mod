...
public class PortalRenderer extends GeoEntityRenderer<PortalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
