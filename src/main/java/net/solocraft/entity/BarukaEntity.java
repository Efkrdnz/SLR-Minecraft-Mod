...
import net.solocraft.procedures.BarukaOnEntityTickUpdateProcedure;
import net.solocraft.procedures.BarukaEntityDiesProcedure;
...
public class BarukaEntity extends Monster implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "baruka2");
...
@Override
	...
	public EntityDimensions getDefaultDimensions(Pose p_33597_) {
		return super.getDefaultDimensions(p_33597_).scale((float) 1.2).withEyeHeight(2.5F);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BarukaEntity.RemovalReason.KILLED);
