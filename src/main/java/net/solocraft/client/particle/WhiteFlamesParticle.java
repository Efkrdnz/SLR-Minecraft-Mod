...
public class WhiteFlamesParticle extends TextureSheetParticle {
	public static WhiteFlamesParticleProvider provider(SpriteSet spriteSet) {
		return new WhiteFlamesParticleProvider(spriteSet);
	}
	...
	public static class WhiteFlamesParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			WhiteFlamesParticle particle = new WhiteFlamesParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
