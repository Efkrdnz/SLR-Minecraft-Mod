...
import net.solocraft.procedures.PaddStealthProcedure;
...
public class StealthStoneItem extends Item {
	public StealthStoneItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		PaddStealthProcedure.execute(entity, ar.getObject());
		return ar;
	}
}
