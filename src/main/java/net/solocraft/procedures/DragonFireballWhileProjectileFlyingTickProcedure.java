...
public class DragonFireballWhileProjectileFlyingTickProcedure {
	private static final double BASE_SPEED = 0.85; // Base movement speed
	private static final double HOMING_STRENGTH = 1; // Higher values make it turn faster
	private static final double MAX_LIFETIME = 80;
	private static final int HOMING_DELAY = 5; // Start homing earlier
	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity projectile) {
		...
		if (world instanceof ServerLevel serverLevel) {
			...
			serverLevel.sendParticles(ParticleTypes.SOUL_FIRE_FLAME, x, y, z, 5, 0.5, 0.5, 0.5, 0);
		}
		// No gravity
