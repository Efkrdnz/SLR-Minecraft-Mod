...
public class ManaRedParticle extends TextureSheetParticle {
	public static ManaRedParticleProvider provider(SpriteSet spriteSet) {
		return new ManaRedParticleProvider(spriteSet);
	}
	...
	public static class ManaRedParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ManaRedParticle particle = new ManaRedParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
