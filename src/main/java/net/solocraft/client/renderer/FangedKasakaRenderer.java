...
import net.solocraft.entity.model.FangedKasakaModel;
...
public class FangedKasakaRenderer extends GeoEntityRenderer<FangedKasakaEntity> {
	public FangedKasakaRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, FangedKasakaEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
