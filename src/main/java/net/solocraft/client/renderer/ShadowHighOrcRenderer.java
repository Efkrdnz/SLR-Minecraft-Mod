...
public class ShadowHighOrcRenderer extends GeoEntityRenderer<ShadowHighOrcEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ShadowHighOrcEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
