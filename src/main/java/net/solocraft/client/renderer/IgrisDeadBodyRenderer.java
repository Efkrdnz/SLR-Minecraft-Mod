...
public class IgrisDeadBodyRenderer extends GeoEntityRenderer<IgrisDeadBodyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IgrisDeadBodyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 0.6f;
