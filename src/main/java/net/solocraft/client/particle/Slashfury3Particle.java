...
public class Slashfury3Particle extends TextureSheetParticle {
	public static Slashfury3ParticleProvider provider(SpriteSet spriteSet) {
		return new Slashfury3ParticleProvider(spriteSet);
	}
	...
	public static class Slashfury3ParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Slashfury3Particle particle = new Slashfury3Particle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
