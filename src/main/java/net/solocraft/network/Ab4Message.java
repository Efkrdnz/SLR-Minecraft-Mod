...
import net.solocraft.procedures.Ab4OnKeyPressedProcedure;
...
public class Ab4Message {
	...
	public static void handler(Ab4Message message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Ab4OnKeyPressedProcedure.execute(entity);
		}
	}
