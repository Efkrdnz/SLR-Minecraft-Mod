...
public class ArrowSplashRenderer extends GeoEntityRenderer<ArrowSplashEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ArrowSplashEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
