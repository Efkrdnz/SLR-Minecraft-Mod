...
import net.solocraft.entity.model.GoblinClubModel;
...
public class GoblinClubRenderer extends GeoEntityRenderer<GoblinClubEntity> {
	public GoblinClubRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, GoblinClubEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
