...
import net.solocraft.entity.model.MagicEyeModel;
...
public class MagicEyeRenderer extends GeoEntityRenderer<MagicEyeEntity> {
	public MagicEyeRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, MagicEyeEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
