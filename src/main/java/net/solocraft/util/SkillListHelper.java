...
public class SkillListHelper {
	private static final List<String> JOB_SKILL_ORDER = List.of(
			...
			JobSkillManager.GRAND_MARSHAL_AUTHORITY,
			...
			// Ruler-vessel rows use the established Thomas/Liu presentation:
			// combat abilities first and the transformation toggle last.
