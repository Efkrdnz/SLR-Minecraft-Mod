...
import net.solocraft.entity.model.FxPuddleModel;
...
public class FxPuddleRenderer extends GeoEntityRenderer<FxPuddleEntity> {
	public FxPuddleRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, FxPuddleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
