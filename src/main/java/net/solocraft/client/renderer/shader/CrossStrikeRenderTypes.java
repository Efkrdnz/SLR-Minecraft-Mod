...
public class CrossStrikeRenderTypes extends RenderStateShard {
	...
	public static void registerShaders(RegisterShadersEvent event) throws IOException {
		event.registerShader(new ShaderInstance(event.getResourceProvider(), ResourceLocation.fromNamespaceAndPath(SololevelingMod.MODID, "rendertype_cross_strike"), WorldShaderVertexFormat.NEW_ENTITY), shader -> crossShader = shader);
	}
	...
	public static RenderType cross(ResourceLocation texture) {
		...
		return RenderType.create("cross_strike", WorldShaderVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 512, false, true, state);
	}
}
