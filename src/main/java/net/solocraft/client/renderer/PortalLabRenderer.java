...
public class PortalLabRenderer extends GeoEntityRenderer<PortalLabEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalLabEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
