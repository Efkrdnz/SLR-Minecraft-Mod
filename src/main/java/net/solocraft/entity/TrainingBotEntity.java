...
import net.solocraft.procedures.TrainingBotOnInitialEntitySpawnProcedure;
import net.solocraft.procedures.TrainingBotEntityIsHurtProcedure;
import net.solocraft.procedures.TrainingBotEntityDiesProcedure;
...
public class TrainingBotEntity extends Monster {
	...
	public TrainingBotEntity(PlayMessages.SpawnEntity packet, Level world) {
