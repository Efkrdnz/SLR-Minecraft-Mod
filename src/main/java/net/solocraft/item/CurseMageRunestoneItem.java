...
/** Shared item implementation for Curse Mage runestones. */
public final class CurseMageRunestoneItem extends Item {
	private final String skill;
	private final String description;

	public CurseMageRunestoneItem(String skill, String description) {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context,
		...
		tooltip.add(Component.literal("Deliveries carry whichever curse you have armed.")
				.withStyle(ChatFormatting.LIGHT_PURPLE));
		tooltip.add(Component.literal("The cooldown belongs to the curse, and grows with how widely you spread it.")
