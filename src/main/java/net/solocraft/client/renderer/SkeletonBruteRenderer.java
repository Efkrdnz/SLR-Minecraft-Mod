...
import net.solocraft.entity.model.SkeletonBruteModel;
...
public class SkeletonBruteRenderer extends GeoEntityRenderer<SkeletonBruteEntity> {
	public SkeletonBruteRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, SkeletonBruteEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
