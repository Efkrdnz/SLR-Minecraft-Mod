...
public class SlashFurry10Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		for (int index0 = 0; index0 < (int) particleNum; index0++) {
			...
			x_pos = x + 3 * entity.getLookAngle().x + radius * vX;
			y_pos = y + 3 * entity.getLookAngle().y + hei + radius * vY;
			z_pos = z + 3 * entity.getLookAngle().z + radius * vZ;
			i = i + 1;
			hei = hei + 0.01666;
