...
public class ShardParticleParticle extends TextureSheetParticle {
	public static ShardParticleParticleProvider provider(SpriteSet spriteSet) {
		return new ShardParticleParticleProvider(spriteSet);
	}
	...
	public static class ShardParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ShardParticleParticle particle = new ShardParticleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
