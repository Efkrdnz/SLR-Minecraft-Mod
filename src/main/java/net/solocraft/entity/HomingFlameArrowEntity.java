...
import net.solocraft.procedures.HomingFlameArrowWhileProjectileFlyingTickProcedure;
import net.solocraft.procedures.HomingFlameArrowProjectileHitsLivingEntityProcedure;
...
public class HomingFlameArrowEntity extends LegacyAbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		HomingFlameArrowProjectileHitsLivingEntityProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this, this.getOwner());
	}
