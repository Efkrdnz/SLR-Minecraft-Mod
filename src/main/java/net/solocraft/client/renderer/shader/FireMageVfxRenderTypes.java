...
public final class FireMageVfxRenderTypes extends RenderStateShard {
	private static ShaderInstance shader;
	private static RenderType cachedEffect;

	private FireMageVfxRenderTypes(String name, Runnable setup, Runnable clear) {
	...
	public static void registerShaders(RegisterShadersEvent event) throws IOException {
		event.registerShader(new ShaderInstance(event.getResourceProvider(),
				ResourceLocation.fromNamespaceAndPath(SololevelingMod.MODID, "rendertype_fire_mage_vfx"),
	...
	public static RenderType effect(ResourceLocation fallback) {
		...
		if (cachedEffect == null) {
			...
			cachedEffect = RenderType.create("fire_mage_vfx", WorldShaderVertexFormat.NEW_ENTITY,
