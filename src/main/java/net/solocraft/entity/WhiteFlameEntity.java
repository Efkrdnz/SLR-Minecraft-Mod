...
import net.solocraft.procedures.WhiteFlameWhileProjectileFlyingTickProcedure;
import net.solocraft.procedures.WhiteFlameProjectileHitsLivingEntityProcedure;
...
public class WhiteFlameEntity extends LegacyAbstractArrow implements ItemSupplier {
	...
	public static WhiteFlameEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 0.4f, 1, 0);
	}
