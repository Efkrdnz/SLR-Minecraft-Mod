...
public class SlashRenderer extends EntityRenderer<SlashEntity> {
	...
	@Override
	public void render(SlashEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(SlashEntity entity) {
		return texture;
	}
}
