...
public class ShamanMagicParticleParticle extends TextureSheetParticle {
	public static ShamanMagicParticleParticleProvider provider(SpriteSet spriteSet) {
		return new ShamanMagicParticleParticleProvider(spriteSet);
	}
	...
	public static class ShamanMagicParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ShamanMagicParticleParticle particle = new ShamanMagicParticleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
