...
import net.solocraft.entity.model.CentipedeModel;
...
public class CentipedeRenderer extends GeoEntityRenderer<CentipedeEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CentipedeEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 3f;
