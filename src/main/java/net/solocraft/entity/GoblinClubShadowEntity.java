...
import net.solocraft.procedures.GoblinClubShadowOnEntityTickUpdateProcedure;
...
public class GoblinClubShadowEntity extends TamableAnimal implements GeoEntity {
	...
	public GoblinClubShadowEntity(PlayMessages.SpawnEntity packet, Level world) {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(21, new OwnerHurtTargetGoal(this));
		this.goalSelector.addGoal(22, new FollowParentGoal(this, 1.6));
		this.goalSelector.addGoal(23, new RandomStrollGoal(this, 0.5));
		this.goalSelector.addGoal(24, new OwnerHurtByTargetGoal(this));
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 40) {
			this.remove(GoblinClubShadowEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
