...
public class PortalAncientGolemRenderer extends GeoEntityRenderer<PortalAncientGolemEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalAncientGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
