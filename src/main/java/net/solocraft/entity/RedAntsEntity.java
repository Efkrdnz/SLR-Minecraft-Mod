...
import net.solocraft.procedures.RedAntsOnEntityTickUpdateProcedure;
...
public class RedAntsEntity extends Monster implements GeoEntity {
	...
	public RedAntsEntity(PlayMessages.SpawnEntity packet, Level world) {
	...
	public RedAntsEntity(EntityType<RedAntsEntity> type, Level world) {
		...
		xpReward = 12;
		setNoAi(false);
		setCustomName(Component.literal("Red Ant"));
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RedAntsEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
