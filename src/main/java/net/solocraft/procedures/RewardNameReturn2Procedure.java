...
public class RewardNameReturn2Procedure {
	public static String execute(Entity entity) {
		...
		String reward = "";
		String reward_list = "";
		reward = (entity.getCapability(SololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SololevelingModVariables.PlayerVariables())).reward_2;
