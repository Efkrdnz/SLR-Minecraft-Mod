...
public class MiniGemGolemRenderer extends GeoEntityRenderer<MiniGemGolemEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MiniGemGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 5f;
