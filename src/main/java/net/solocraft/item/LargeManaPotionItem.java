...
public class LargeManaPotionItem extends Item {
	public LargeManaPotionItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A76Restores a large portion of users mana after consuming."));
	}
