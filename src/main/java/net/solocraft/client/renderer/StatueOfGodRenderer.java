...
public class StatueOfGodRenderer extends GeoEntityRenderer<StatueOfGodEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, StatueOfGodEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 3f;
