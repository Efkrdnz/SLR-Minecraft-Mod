...
import net.solocraft.entity.model.PortalLushModel;
...
public class PortalLushRenderer extends GeoEntityRenderer<PortalLushEntity> {
	public PortalLushRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalLushEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
