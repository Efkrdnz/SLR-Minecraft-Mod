...
import net.solocraft.entity.model.FireFlyModel;
import net.solocraft.entity.layer.FireFlyLayer;
...
public class FireFlyRenderer extends GeoEntityRenderer<FireFlyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FireFlyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 3f;
