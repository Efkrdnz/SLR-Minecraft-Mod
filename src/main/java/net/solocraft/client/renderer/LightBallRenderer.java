...
public class LightBallRenderer extends EntityRenderer<LightBallEntity> {
	...
	public LightBallRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modellight_ball(context.bakeLayer(Modellight_ball.LAYER_LOCATION));
	}

	@Override
	public void render(LightBallEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
