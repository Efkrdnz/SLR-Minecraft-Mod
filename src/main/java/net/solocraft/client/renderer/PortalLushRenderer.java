...
public class PortalLushRenderer extends GeoEntityRenderer<PortalLushEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalLushEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
