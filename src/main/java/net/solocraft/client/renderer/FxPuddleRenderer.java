...
public class FxPuddleRenderer extends GeoEntityRenderer<FxPuddleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FxPuddleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
