...
import net.solocraft.procedures.RunestoneShadowstepRCProcedure;
...
public class RunestoneShadowstepItem extends Item {
	public RunestoneShadowstepItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		RunestoneShadowstepRCProcedure.execute(entity, ar.getObject());
		return ar;
	}
}
