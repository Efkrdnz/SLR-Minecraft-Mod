...
public class ShadowIgrisEntity extends TamableAnimal implements GeoEntity {
	...
	public ShadowIgrisEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SololevelingModEntities.SHADOW_IGRIS.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "igrisshadowalt");
	}
