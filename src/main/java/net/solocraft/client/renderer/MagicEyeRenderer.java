...
public class MagicEyeRenderer extends GeoEntityRenderer<MagicEyeEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MagicEyeEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
