...
public class LightningBlueParticle extends TextureSheetParticle {
	public static LightningBlueParticleProvider provider(SpriteSet spriteSet) {
		return new LightningBlueParticleProvider(spriteSet);
	}
	...
	public static class LightningBlueParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			LightningBlueParticle particle = new LightningBlueParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
