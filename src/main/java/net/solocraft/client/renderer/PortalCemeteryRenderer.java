...
public class PortalCemeteryRenderer extends GeoEntityRenderer<PortalCemeteryEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalCemeteryEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
