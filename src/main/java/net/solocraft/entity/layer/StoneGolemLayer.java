...
public class StoneGolemLayer extends GeoRenderLayer<StoneGolemEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath("sololeveling", "textures/entities/stonegolemglowtext.png");
	...
	@Override
	public void render(PoseStack poseStack, StoneGolemEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
