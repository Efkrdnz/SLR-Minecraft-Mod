...
public class SteelFangedLycanRenderer extends GeoEntityRenderer<SteelFangedLycanEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SteelFangedLycanEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
