...
public class RedGateRenderer extends GeoEntityRenderer<RedGateEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RedGateEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 2f;
