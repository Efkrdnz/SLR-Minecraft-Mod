...
import net.solocraft.entity.model.DummyPortalPurpleModel;
...
public class DummyPortalPurpleRenderer extends GeoEntityRenderer<DummyPortalPurpleEntity> {
	public DummyPortalPurpleRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, DummyPortalPurpleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
