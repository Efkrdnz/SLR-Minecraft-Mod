...
public class PanelEarlyMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PanelEarlyMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SololevelingModMenus.PANEL_EARLY.get(), id);
	...
	public void removed(Player playerIn) {
		...
		PanelEarlyThisGUIIsClosedProcedure.execute(world, x, y, z);
	}
