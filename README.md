...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.3.0-3F88C5" alt="Version 1.3.0">
...
3. Place `SLR1.3.0-neoforge-1.21.1.jar` and the GeckoLib jar in your `mods` folder.
...
```text
build/libs/SLR1.3.0-neoforge-1.21.1.jar
```
