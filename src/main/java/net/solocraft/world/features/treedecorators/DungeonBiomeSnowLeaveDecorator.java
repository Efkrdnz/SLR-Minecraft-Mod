...
public class DungeonBiomeSnowLeaveDecorator extends LeaveVineDecorator {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("dungeon_biome_snow_tree_leave_decorator", DECORATOR_TYPE));
	}
