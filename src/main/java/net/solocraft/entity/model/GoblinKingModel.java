...
public class GoblinKingModel extends GeoModel<GoblinKingEntity> {
	...
	public ResourceLocation getAnimationResource(GoblinKingEntity entity) {
		return new ResourceLocation("sololeveling", "animations/goblin_boss.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(GoblinKingEntity entity) {
		return new ResourceLocation("sololeveling", "geo/goblin_boss.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(GoblinKingEntity animatable, long instanceId, AnimationState animationState) {
