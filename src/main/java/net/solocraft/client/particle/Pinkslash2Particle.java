...
public class Pinkslash2Particle extends TextureSheetParticle {
	public static Pinkslash2ParticleProvider provider(SpriteSet spriteSet) {
		return new Pinkslash2ParticleProvider(spriteSet);
	}
	...
	public static class Pinkslash2ParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Pinkslash2Particle particle = new Pinkslash2Particle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
