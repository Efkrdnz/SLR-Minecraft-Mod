...
import net.solocraft.procedures.StopPotionGUIopenProcedure;
import net.solocraft.procedures.OpenShopProcedure;
import net.solocraft.procedures.OpenMistItemsProcedure;
import net.solocraft.procedures.OpenFoodGuiProcedure;
...
public class StoreGUIButtonMessage {
	...
	public static void handler(StoreGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
