...
public class ModelFlameArrow<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flamearrow"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arrow = partdefinition.addOrReplaceChild("arrow", CubeListBuilder.create().texOffs(-5, 5).addBox(
				-3.5F, 11.0F, -2.5F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 13.0F, 0.0F));

		PartDefinition cube_r1 = arrow.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(13, -2).mirror()
						.addBox(0.0F, -2.5F, 1.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r2 = arrow.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(16, -8).mirror()
						.addBox(0.0F, -3.5F, -4.0F, 0.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.0F, -1.5708F, -1.5708F));

		PartDefinition cube_r3 = arrow.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, -8).addBox(0.0F, -2.5F, -4.5F, 0.0F, 5.0F, 8.0F,
						new CubeDeformation(0.0003F)),
				PartPose.offsetAndRotation(-1.0F, 8.475F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r4 = arrow.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(13, -2).mirror()
						.addBox(0.0F, -1.5F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
