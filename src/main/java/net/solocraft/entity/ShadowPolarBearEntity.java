...
public class ShadowPolarBearEntity extends TamableAnimal implements GeoEntity {
	...
	public ShadowPolarBearEntity(PlayMessages.SpawnEntity packet, Level world) {
	...
	public static void init() {
		SpawnPlacements.register(SololevelingModEntities.SHADOW_POLAR_BEAR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShadowPolarBearEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
