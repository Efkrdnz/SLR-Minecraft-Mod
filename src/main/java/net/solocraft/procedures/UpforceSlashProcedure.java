			...
			if (!CooldownManager.isOnCooldown(entity, "Ground Slam")) {
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						...
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.anvil.place")), SoundSource.NEUTRAL, (float) 0.5, 1, false);
					}
				}
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
				...
				world.addParticle(ParticleTypes.EXPLOSION_EMITTER, (entity.getX()), (entity.getY()), (entity.getZ()), 0, 1, 0);
				{
