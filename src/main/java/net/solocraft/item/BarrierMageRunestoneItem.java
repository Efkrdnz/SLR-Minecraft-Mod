...
public class BarrierMageRunestoneItem extends Item {
	private final String skill;
	private final String description;

	public BarrierMageRunestoneItem(String skill, String description) {
	...
	public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		tooltip.add(Component.literal("Geometry and control evolve through five Intelligence outputs.")
