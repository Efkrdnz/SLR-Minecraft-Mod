...
public class FlagOfProtectionRenderer extends GeoEntityRenderer<FlagOfProtectionEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FlagOfProtectionEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 2f;
