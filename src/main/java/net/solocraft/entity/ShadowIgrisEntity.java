...
import net.solocraft.procedures.ShadowIgrisRightClickedOnEntityProcedure;
import net.solocraft.procedures.ShadowIgrisEntityDiesProcedure;
...
public class ShadowIgrisEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ShadowIgrisEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ShadowIgrisEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ShadowIgrisEntity.class, EntityDataSerializers.STRING);
	...
	public ShadowIgrisEntity(EntityType<ShadowIgrisEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "igrisshadowalt");
	}
...
@Override
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, GoblinArcherEntity.class, false, false) {
			...
			public boolean canUse() {
				double x = ShadowIgrisEntity.this.getX();
				double y = ShadowIgrisEntity.this.getY();
				double z = ShadowIgrisEntity.this.getZ();
				Entity entity = ShadowIgrisEntity.this;
				Level world = ShadowIgrisEntity.this.level();
		...
		this.goalSelector.addGoal(16, new FollowOwnerGoal(this, 1, (float) 30, (float) 5) {
			@Override
			public boolean canUse() {
				double x = ShadowIgrisEntity.this.getX();
				double y = ShadowIgrisEntity.this.getY();
			...
			@Override
			public boolean canContinueToUse() {
				return super.canContinueToUse() && IsNotBerserkProcedure.execute(ShadowIgrisEntity.this);
			}
		});
	...
	public void die(DamageSource source) {
		super.die(source);
		ShadowIgrisEntityDiesProcedure.execute(this);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ShadowIgrisRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public EntityDimensions getDefaultDimensions(Pose p_33597_) {
		return super.getDefaultDimensions(p_33597_).scale((float) 1).withEyeHeight(3F);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ShadowIgrisEntity retval = SololevelingModEntities.SHADOW_IGRIS.get().create(serverWorld);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ARMOR, 65);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 10) {
			this.remove(ShadowIgrisEntity.RemovalReason.KILLED);
