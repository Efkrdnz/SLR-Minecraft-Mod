...
import net.solocraft.procedures.RunestoneDualwieldRCProcedure;
...
public class RunestoneDualwieldItem extends Item {
	public RunestoneDualwieldItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		RunestoneDualwieldRCProcedure.execute(entity, ar.getObject());
		return ar;
	}
}
