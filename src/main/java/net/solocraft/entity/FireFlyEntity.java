...
import net.solocraft.procedures.FireflyuEntityIsHurtProcedure;
...
public class FireFlyEntity extends TamableAnimal implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, FireFlyEntity.class, (float) 6, 1, 1.2));
		...
		this.goalSelector.addGoal(5, new Goal() {
			...
			public boolean canUse() {
				if (FireFlyEntity.this.getTarget() != null && !FireFlyEntity.this.getMoveControl().hasWanted()) {
					return true;
				} else {
					return false;
				}
			...
			public void start() {
				...
				FireFlyEntity.this.moveControl.setWantedPosition(vec3d.x, vec3d.y, vec3d.z, 3);
			}
	...
	protected net.minecraft.world.phys.Vec3 getPassengerAttachmentPoint(net.minecraft.world.entity.Entity passenger,
		...
		return super.getPassengerAttachmentPoint(passenger, dimensions, scaleFactor).add(0.0D, 3.5D, 0.0D);
	}
	...
	public EntityDimensions getDefaultDimensions(Pose p_33597_) {
		return super.getDefaultDimensions(p_33597_).scale((float) 3);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(FireFlyEntity.RemovalReason.KILLED);
