...
public class AuraBlueParticle extends TextureSheetParticle {
	public static AuraBlueParticleProvider provider(SpriteSet spriteSet) {
		return new AuraBlueParticleProvider(spriteSet);
	}
	...
	public static class AuraBlueParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			AuraBlueParticle particle = new AuraBlueParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
