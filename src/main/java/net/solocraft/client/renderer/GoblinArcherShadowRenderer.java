...
public class GoblinArcherShadowRenderer extends GeoEntityRenderer<GoblinArcherShadowEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, GoblinArcherShadowEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
