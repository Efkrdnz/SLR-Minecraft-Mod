...
public class KaiselinRenderer<T extends KaiselinEntity> extends GeoEntityRenderer<T> {
	...
	@Override
	public void preRender(PoseStack poseStack, T entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.1f;
