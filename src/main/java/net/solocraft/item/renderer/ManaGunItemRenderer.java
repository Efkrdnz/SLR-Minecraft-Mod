...
import net.solocraft.item.model.ManaGunItemModel;
...
public class ManaGunItemRenderer extends GeoItemRenderer<ManaGunItem> {
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, ManaGunItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
