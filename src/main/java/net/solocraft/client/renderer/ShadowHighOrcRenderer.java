...
import net.solocraft.entity.model.ShadowHighOrcModel;
...
public class ShadowHighOrcRenderer extends GeoEntityRenderer<ShadowHighOrcEntity> {
	public ShadowHighOrcRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, ShadowHighOrcEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
