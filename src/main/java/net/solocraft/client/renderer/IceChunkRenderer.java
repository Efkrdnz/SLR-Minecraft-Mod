...
import net.solocraft.entity.model.IceChunkModel;
import net.solocraft.entity.layer.IceChunkLayer;
...
public class IceChunkRenderer extends GeoEntityRenderer<IceChunkEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IceChunkEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 6f;
