...
import net.solocraft.procedures.GoblinClubOnEntityTickUpdateProcedure;
...
public class GoblinClubEntity extends Monster implements GeoEntity, DungeonScalableEntity {
	...
	public GoblinClubEntity(EntityType<GoblinClubEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Goblin"));
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "goblin_club");
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 40) {
			this.remove(GoblinClubEntity.RemovalReason.KILLED);
