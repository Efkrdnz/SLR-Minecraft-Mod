...
public final class WhiteFlameVfxRenderTypes extends RenderStateShard {
	...
	public static void registerShaders(RegisterShadersEvent event) throws IOException {
		event.registerShader(new ShaderInstance(event.getResourceProvider(),
				ResourceLocation.fromNamespaceAndPath(SololevelingMod.MODID, "rendertype_white_flame_vfx"),
	...
	public static RenderType effect(ResourceLocation fallback) {
		...
		return RenderType.create("white_flame_vfx", WorldShaderVertexFormat.NEW_ENTITY,
