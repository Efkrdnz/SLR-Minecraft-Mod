...
import net.solocraft.procedures.Ab3OnKeyPressedProcedure;
...
public class Ab3Message {
	...
	public static void handler(Ab3Message message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Ab3OnKeyPressedProcedure.execute(entity);
		}
	}
