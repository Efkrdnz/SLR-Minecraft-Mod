...
public class DungeonWallTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DungeonWallTileEntity(BlockPos pos, BlockState state) {
		super(SololevelingModBlockEntities.DUNGEON_WALL.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DungeonWallTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DungeonWallTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("dungeon_wall");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Dungeon Wall");
	}
