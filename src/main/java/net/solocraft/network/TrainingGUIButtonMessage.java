...
import net.solocraft.procedures.SpawnTrainingOpProcedure;
...
public class TrainingGUIButtonMessage {
	...
	public static void handler(TrainingGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SololevelingMod.addNetworkMessage(TrainingGUIButtonMessage.class, TrainingGUIButtonMessage::buffer, TrainingGUIButtonMessage::new, TrainingGUIButtonMessage::handler);
	}
}
