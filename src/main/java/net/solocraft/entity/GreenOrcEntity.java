...
public class GreenOrcEntity extends Monster implements GeoEntity, DungeonScalableEntity {
	...
	public GreenOrcEntity(EntityType<GreenOrcEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	...
	public EntityDimensions getDefaultDimensions(Pose p_33597_) {
		return super.getDefaultDimensions(p_33597_).scale(0.7F * this.getDungeonScale());
	}
	...
	protected void tickDeath() {
		++this.deathTime;
		if (this.deathTime == 9) {
			this.remove(GreenOrcEntity.RemovalReason.KILLED);
