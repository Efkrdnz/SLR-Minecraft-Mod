...
public class SkeletonBruteEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SkeletonBruteEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SkeletonBruteEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SkeletonBruteEntity.class, EntityDataSerializers.STRING);
	...
	public SkeletonBruteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SololevelingModEntities.SKELETON_BRUTE.get(), world);
	}

	public SkeletonBruteEntity(EntityType<SkeletonBruteEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "nocsy_skeleton_brute_skin");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 25) {
			this.remove(SkeletonBruteEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
