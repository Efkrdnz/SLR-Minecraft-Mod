...
import net.solocraft.entity.model.MagicalSkullModel;
import net.solocraft.entity.layer.MagicalSkullLayer;
...
public class MagicalSkullRenderer extends GeoEntityRenderer<MagicalSkullEntity> {
	public MagicalSkullRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, MagicalSkullEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
