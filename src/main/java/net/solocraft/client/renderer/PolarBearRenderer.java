...
public class PolarBearRenderer extends GeoEntityRenderer<PolarBearEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PolarBearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
