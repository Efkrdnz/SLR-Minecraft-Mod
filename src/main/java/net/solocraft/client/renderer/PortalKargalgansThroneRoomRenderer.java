...
public class PortalKargalgansThroneRoomRenderer extends GeoEntityRenderer<PortalKargalgansThroneRoomEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalKargalgansThroneRoomEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
