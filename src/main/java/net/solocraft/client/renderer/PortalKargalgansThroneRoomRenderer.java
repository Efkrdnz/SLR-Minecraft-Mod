...
import net.solocraft.entity.model.PortalKargalgansThroneRoomModel;
...
public class PortalKargalgansThroneRoomRenderer extends GeoEntityRenderer<PortalKargalgansThroneRoomEntity> {
	public PortalKargalgansThroneRoomRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, PortalKargalgansThroneRoomEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
