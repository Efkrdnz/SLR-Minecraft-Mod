...
public class MediumFatiguePotionItem extends Item {
	public MediumFatiguePotionItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A76Restores a portion of users fatigue after consuming."));
	}
