...
public class Portal1Renderer extends GeoEntityRenderer<Portal1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, Portal1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
