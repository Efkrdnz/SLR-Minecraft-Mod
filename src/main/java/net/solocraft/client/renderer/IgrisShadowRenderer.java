...
public class IgrisShadowRenderer extends GeoEntityRenderer<IgrisShadowEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IgrisShadowEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 0.6f;
