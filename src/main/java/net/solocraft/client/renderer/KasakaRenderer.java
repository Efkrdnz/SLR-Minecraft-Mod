...
import net.solocraft.entity.model.KasakaModel;
...
public class KasakaRenderer extends GeoEntityRenderer<KasakaEntity> {
	public KasakaRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, KasakaEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 2f;
