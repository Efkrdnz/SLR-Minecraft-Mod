...
public class Slashfury4Particle extends TextureSheetParticle {
	public static Slashfury4ParticleProvider provider(SpriteSet spriteSet) {
		return new Slashfury4ParticleProvider(spriteSet);
	}
	...
	public static class Slashfury4ParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Slashfury4Particle particle = new Slashfury4Particle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
