...
import net.solocraft.procedures.ShadowSoulOnInitialEntitySpawnProcedure;
import net.solocraft.procedures.ShadowSoulOnEntityTickUpdateProcedure;
import net.solocraft.procedures.ARISEProcedure;
...
public class ShadowSoulEntity extends PathfinderMob {
	...
	public ShadowSoulEntity(PlayMessages.SpawnEntity packet, Level world) {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ARISEProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
