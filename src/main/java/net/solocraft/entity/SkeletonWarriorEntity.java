...
public class SkeletonWarriorEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SkeletonWarriorEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SkeletonWarriorEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SkeletonWarriorEntity.class, EntityDataSerializers.STRING);
	...
	public SkeletonWarriorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SololevelingModEntities.SKELETON_WARRIOR.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "nocsy_skeleton_warrior");
	}
