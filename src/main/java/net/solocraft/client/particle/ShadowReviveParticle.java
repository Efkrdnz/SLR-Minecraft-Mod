...
public class ShadowReviveParticle extends TextureSheetParticle {
	public static ShadowReviveParticleProvider provider(SpriteSet spriteSet) {
		return new ShadowReviveParticleProvider(spriteSet);
	}
	...
	public static class ShadowReviveParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ShadowReviveParticle particle = new ShadowReviveParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
