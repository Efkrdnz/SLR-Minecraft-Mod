...
public class RunestoneBlessingMarkRCProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (!((entity.getCapability(SololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SololevelingModVariables.PlayerVariables())).Plist).contains("Blessing Mark")) {
			{
				String _setval = (entity.getCapability(SololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SololevelingModVariables.PlayerVariables())).Plist + "Blessing Mark" + ",";
