...
public class RandomCaveLargeRenderer extends GeoEntityRenderer<RandomCaveLargeEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RandomCaveLargeEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
