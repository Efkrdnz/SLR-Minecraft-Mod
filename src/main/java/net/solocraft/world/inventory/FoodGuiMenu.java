...
import net.solocraft.procedures.FoodGuiWhileThisGUIIsOpenTickProcedure;
...
public class FoodGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FoodGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, -53, -84) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, -53, -57) {
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, -53, -30) {
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (true && entity.containerMenu instanceof FoodGuiMenu) {
