...
public class PanelReworkButtonMessage {
	...
	public static void handler(PanelReworkButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SololevelingMod.addNetworkMessage(PanelReworkButtonMessage.class, PanelReworkButtonMessage::buffer, PanelReworkButtonMessage::new, PanelReworkButtonMessage::handler);
	}
}
