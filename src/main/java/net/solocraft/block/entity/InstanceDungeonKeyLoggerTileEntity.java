...
public class InstanceDungeonKeyLoggerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<InstanceDungeonKeyLoggerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<InstanceDungeonKeyLoggerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
