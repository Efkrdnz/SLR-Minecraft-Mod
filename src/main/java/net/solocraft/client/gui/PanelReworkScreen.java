...
public class PanelReworkScreen extends AbstractContainerScreen<PanelReworkMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("sololeveling:textures/screens/panel_rework.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("sololeveling:textures/screens/panel_rework_6.png"), this.leftPos + -113, this.topPos + -105, 0, 0, 225, 190, 225, 190);
	...
	public void init() {
		super.init();
		imagebutton_normal_quest = new LegacyAtlasImageButton(this.leftPos + -144, this.topPos + 15, 32, 34, 0, 0, 34, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_normal_quest.png"), 32, 68, e -> {
			if (true) {
		...
		imagebutton_normal_reward = new LegacyAtlasImageButton(this.leftPos + -144, this.topPos + -25, 32, 34, 0, 0, 34, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_normal_reward.png"), 32, 68, e -> {
			if (true) {
		...
		imagebutton_normal_store = new LegacyAtlasImageButton(this.leftPos + -144, this.topPos + -66, 32, 34, 0, 0, 34, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_normal_store.png"), 32, 68, e -> {
			if (true) {
		...
		imagebutton_normal_abilities = new LegacyAtlasImageButton(this.leftPos + 111, this.topPos + -66, 32, 34, 0, 0, 34, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_normal_abilities.png"), 32, 68, e -> {
			if (true) {
		...
		imagebutton_normal_training = new LegacyAtlasImageButton(this.leftPos + 112, this.topPos + -26, 32, 34, 0, 0, 34, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_normal_training.png"), 32, 68, e -> {
			if (true) {
		...
		imagebutton_normal_craft = new LegacyAtlasImageButton(this.leftPos + 111, this.topPos + 14, 32, 34, 0, 0, 34, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_normal_craft.png"), 32, 68, e -> {
			if (true) {
		...
		imagebutton_invest2 = new LegacyAtlasImageButton(this.leftPos + -87, this.topPos + 2, 7, 7, 0, 0, 7, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_invest2.png"), 7, 14, e -> {
			if (true) {
		...
		imagebutton_invest21 = new LegacyAtlasImageButton(this.leftPos + -87, this.topPos + 18, 7, 7, 0, 0, 7, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_invest21.png"), 7, 14, e -> {
			if (true) {
		...
		imagebutton_invest22 = new LegacyAtlasImageButton(this.leftPos + -87, this.topPos + 34, 7, 7, 0, 0, 7, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_invest22.png"), 7, 14, e -> {
			if (true) {
		...
		imagebutton_invest23 = new LegacyAtlasImageButton(this.leftPos + 79, this.topPos + 2, 7, 7, 0, 0, 7, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_invest23.png"), 7, 14, e -> {
			if (true) {
		...
		imagebutton_invest24 = new LegacyAtlasImageButton(this.leftPos + 79, this.topPos + 18, 7, 7, 0, 0, 7, ResourceLocation.parse("sololeveling:textures/screens/atlas/imagebutton_invest24.png"), 7, 14, e -> {
			if (true) {
