...
public class DummyPortalNormalRenderer extends GeoEntityRenderer<DummyPortalNormalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, DummyPortalNormalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
