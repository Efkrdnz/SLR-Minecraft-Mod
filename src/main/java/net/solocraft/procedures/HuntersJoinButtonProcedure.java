...
public class HuntersJoinButtonProcedure {
		...
		if ((entity.getCapability(SololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SololevelingModVariables.PlayerVariables())).GuildCode != 1) {
			if ((entity.getCapability(SololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SololevelingModVariables.PlayerVariables())).Level >= 25) {
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal(("\u00A74" + "Choi Jong-In:" + "\u00A7f" + "Interesting...")), false);
				SololevelingMod.queueServerWork(40, () -> {
					{
						...
						if (!_ent.level().isClientSide() && _ent.getServer() != null) {
							_ent.getServer().getCommands().performPrefixedCommand(
									...
									"/title @p title {\"text\":\"Welcome to Hunters guild!\",\"color\":\"red\",\"bold\":true,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}");
						}
					}
					...
					SololevelingMod.queueServerWork(40, () -> {
						if (entity instanceof Player _player && !_player.level().isClientSide())
							_player.displayClientMessage(Component.literal(("\u00A74" + "Choi Jong-In:" + "\u00A7f" + "I'm looking forward to your work in our guild")), false);
					});
				});
			} else {
				if (entity instanceof Player _player)
					_player.closeContainer();
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal(("\u00A74" + "Choi Jong-In:" + "\u00A7f" + "Get stronger! This guild is too early for you.")), false);
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal(("\u00A74" + "Choi Jong-In:" + "\u00A7f" + "I'm busy right now...")), false);
		}
	}
}
