...
public class SkeletonWarriorRenderer extends GeoEntityRenderer<SkeletonWarriorEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SkeletonWarriorEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
