...
public class SteelFangWolfModel extends GeoModel<SteelFangWolfEntity> {
	...
	public ResourceLocation getAnimationResource(SteelFangWolfEntity entity) {
		return ResourceLocation.fromNamespaceAndPath("sololeveling", "animations/lycan.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SteelFangWolfEntity entity) {
		return ResourceLocation.fromNamespaceAndPath("sololeveling", "geo/lycan.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(SteelFangWolfEntity entity) {
		return ResourceLocation.fromNamespaceAndPath("sololeveling", "textures/entities/" + entity.getSoloTexture() + ".png");
	}
