...
import net.solocraft.procedures.BuyWeaponSProcedure;
import net.solocraft.procedures.BuyWeaponEProcedure;
import net.solocraft.procedures.BuyWeaponDProcedure;
import net.solocraft.procedures.BuyWeaponCProcedure;
import net.solocraft.procedures.BuyWeaponBProcedure;
import net.solocraft.procedures.BuyWeaponAProcedure;
...
public class StoreWeaponButtonMessage {
	...
	public static void handler(StoreWeaponButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SololevelingMod.addNetworkMessage(StoreWeaponButtonMessage.class, StoreWeaponButtonMessage::buffer, StoreWeaponButtonMessage::new, StoreWeaponButtonMessage::handler);
	}
}
