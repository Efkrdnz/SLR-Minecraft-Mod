...
public class SteelFangWolfShadowRenderer extends GeoEntityRenderer<SteelFangWolfShadowEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SteelFangWolfShadowEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.2f;
