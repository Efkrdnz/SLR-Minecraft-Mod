...
public class MediumHealthPotionItem extends Item {
	public MediumHealthPotionItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A76Restores a portion of users health after consuming."));
	}
