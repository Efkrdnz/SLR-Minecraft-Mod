...
public class DaggerSlashRenderer extends GeoEntityRenderer<DaggerSlashEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, DaggerSlashEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
