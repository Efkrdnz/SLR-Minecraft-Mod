...
public class StatueswordEntity extends Monster implements GeoEntity {
	...
	public StatueswordEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SololevelingModEntities.STATUESWORD.get(), world);
	}

	public StatueswordEntity(EntityType<StatueswordEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(StatueswordEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
