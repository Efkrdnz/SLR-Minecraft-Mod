...
import net.solocraft.entity.model.IgrisModel;
...
public class IgrisRenderer extends GeoEntityRenderer<IgrisEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IgrisEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 0.5f;
