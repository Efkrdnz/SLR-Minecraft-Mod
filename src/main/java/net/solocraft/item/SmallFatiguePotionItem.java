...
public class SmallFatiguePotionItem extends Item {
	public SmallFatiguePotionItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A76Restores a small portion of users fatigue after consuming."));
	}
