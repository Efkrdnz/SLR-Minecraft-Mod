...
import net.solocraft.procedures.KasakaEntityIsHurtProcedure;
...
public class KasakaEntity extends Monster implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "serpenttexture");
	}
...
@Override
	...
	public EntityDimensions getDefaultDimensions(Pose p_33597_) {
		return super.getDefaultDimensions(p_33597_).scale((float) 2).withEyeHeight(3.5F);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(KasakaEntity.RemovalReason.KILLED);
