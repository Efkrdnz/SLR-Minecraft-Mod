...
public class AttackshardRenderer extends GeoEntityRenderer<AttackshardEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, AttackshardEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.4f;
