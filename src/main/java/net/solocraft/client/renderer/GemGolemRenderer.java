...
import net.solocraft.entity.model.GemGolemModel;
...
public class GemGolemRenderer extends GeoEntityRenderer<GemGolemEntity> {
	public GemGolemRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, GemGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1.5f;
